#1.create a class book with member as bid,bname,price and author. add following methods.
#a.constructor(support both paramerterized and parameterless)
#2.Destructor
#3.showbook
#4.Add static variable count and also maintain count of object created.
class Book:
    #static variable
    bookcount=0
    #Constructor
